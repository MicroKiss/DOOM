...
void P_LoadVertexes(int lump)
{
    ...
    vertexes = static_cast<decltype(vertexes)>(Z_Malloc(numvertexes * sizeof(vertex_t), PU_LEVEL, 0));
...
void P_LoadSectors(int lump)
{
    ...
    sectors = static_cast<decltype(sectors)>(Z_Malloc(numsectors * sizeof(sector_t), PU_LEVEL, 0));
...
void P_LoadSideDefs(int lump)
{
    ...
    sides = static_cast<decltype(sides)>(Z_Malloc(numsides * sizeof(side_t), PU_LEVEL, 0));
...
void P_LoadBlockMap(int lump)
{
    ...
    blockmaplump = static_cast<decltype(blockmaplump)>(W_CacheLumpNum(lump, PU_LEVEL));
    ...
    blocklinks = static_cast<decltype(blocklinks)>(Z_Malloc(count, PU_LEVEL, 0));
...
void P_GroupLines(void)
{
    ...
    linebuffer = static_cast<decltype(linebuffer)>(Z_Malloc(total * sizeof(*linebuffer), PU_LEVEL, 0));
    sector = sectors;
                  ...
                  skill_t skill)
{
    ...
    rejectmatrix = static_cast<decltype(rejectmatrix)>(W_CacheLumpNum(lumpnum + ML_REJECT, PU_LEVEL));
    P_GroupLines();
