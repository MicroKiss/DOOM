...
gamestate_t wipegamestate = GS_MENUSCREEN;
...
void D_Display(void)
{
    ...
    case GS_MENUSCREEN:
        V_DrawPatch(0, 0, 0, static_cast<patch_t *>(W_CacheLumpName("TITLEPIC", PU_CACHE)));
        break;
    }
...
void D_DoomLoop(void)
{
    ...
    while (1)
    {
        ...
        S_UpdateSounds(gamePlayer.mo); // move positional sounds
...
void D_DoomMain(void)
{
    ...
    {
        int scale = 200;
        extern int32_t forwardWalkSpeed;
        extern int32_t forwardRunSpeed;
        extern int32_t sideWalkSpeed;
        extern int32_t sideRunSpeed;
        ...
        forwardWalkSpeed = forwardWalkSpeed * scale / 100;
        forwardRunSpeed = forwardRunSpeed * scale / 100;
        sideWalkSpeed = sideWalkSpeed * scale / 100;
        sideRunSpeed = sideRunSpeed * scale / 100;
    }
