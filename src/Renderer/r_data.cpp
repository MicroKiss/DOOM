...
#include "r_data.hpp"
    ...
    static_assert(sizeof(mappatch_t) == 10, "mappatch_t must match the WAD format");
    static_assert(sizeof(maptexture_t) == 32, "maptexture_t must match the WAD format");
...
void R_InitTextures(void)
{
    ...
    memcpy(&nummappatches, names, sizeof(nummappatches));
    ...
    maptex = maptex1 = static_cast<int32_t *>(W_CacheLumpName("TEXTURE1", PU_STATIC));
    ...
    {
        maptex2 = static_cast<int32_t *>(W_CacheLumpName("TEXTURE2", PU_STATIC));
    ...
    textureheight = static_cast<int32_t *>(Z_Malloc(numtextures * sizeof(*textureheight), PU_STATIC, 0));
    ...
    for (i = 0; i < numtextures; i++, directory++)
    {
        ...
        texturecolumnlump[i] = static_cast<short *>(Z_Malloc(texture->width * sizeof(*texturecolumnlump[i]), PU_STATIC, 0));
        texturecolumnofs[i] = static_cast<unsigned short *>(Z_Malloc(texture->width * sizeof(*texturecolumnofs[i]), PU_STATIC, 0));
...
void R_InitSpriteLumps(void)
{
    ...
    spritewidth = static_cast<int32_t *>(Z_Malloc(numspritelumps * sizeof(*spritewidth), PU_STATIC, 0));
    spriteoffset = static_cast<int32_t *>(Z_Malloc(numspritelumps * sizeof(*spriteoffset), PU_STATIC, 0));
    spritetopoffset = static_cast<int32_t *>(Z_Malloc(numspritelumps * sizeof(*spritetopoffset), PU_STATIC, 0));
